...
namespace Drupal\localgov_login_page\Form;
...
/**
 * Login page settings for class.
 */
class LoginPageSettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'localgov_login_page_settings_form';
  }
  ...
  protected function getEditableConfigNames() {
    return ['localgov_login_page.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('localgov_login_page.settings');
    ...
    $form['redirect_route'] = [
      ...
      '#description' => $this->t('The Drupal route to redirect users to once logged in. This is <strong>not</strong> the path.'),
